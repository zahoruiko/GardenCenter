...
export const useGetCategoryPageSourceDataUrl = (
  categoryId: number,
  ...
  useEffect(() => {
    ...
    if (currentSearchTermState === '') {
      if (currentShowOnlyDiscountedProductsState) {
        setDataUrl(
          `/products/category/${categoryId}/discounted/minPrice/${minPrice}/maxPrice/${maxPrice}/sortBy/${querySortParams.sortFieldName}/sortDirection/${querySortParams.sortDirection}?offset=${offset}&limit=${limit}`
        );
      } else {
        setDataUrl(
          `/products/category/${categoryId}/minPrice/${minPrice}/maxPrice/${maxPrice}/sortBy/${querySortParams.sortFieldName}/sortDirection/${querySortParams.sortDirection}?offset=${offset}&limit=${limit}`
        );
      }
    } else {
      if (currentShowOnlyDiscountedProductsState) {
        setDataUrl(
          `/products/category/${categoryId}/searchTerm/${currentSearchTermState}/discounted/minPrice/${minPrice}/maxPrice/${maxPrice}/sortBy/${querySortParams.sortFieldName}/sortDirection/${querySortParams.sortDirection}?offset=${offset}&limit=${limit}`
        );
      } else {
        setDataUrl(
          `/products/category/${categoryId}/searchTerm/${currentSearchTermState}/minPrice/${minPrice}/maxPrice/${maxPrice}/sortBy/${querySortParams.sortFieldName}/sortDirection/${querySortParams.sortDirection}?offset=${offset}&limit=${limit}`
        );
      }
    }
  }, [
