...
export const useAllProductsSourceDataUrl = (
  ...
  useEffect(() => {
    ...
    if (currentSearchTermState === '') {
      if (currentShowOnlyDiscountedProductsState) {
        ...
        setDataUrl(
          `/products/all/minPrice/${minPrice}/maxPrice/${maxPrice}/sortBy/${querySortParams.sortFieldName}/sortDirection/${querySortParams.sortDirection}?offset=${offset}&limit=${limit}`
        );
      }
    } else {
      if (currentShowOnlyDiscountedProductsState) {
        ...
        setDataUrl(
          `/products/find/${currentSearchTermState}/minPrice/${minPrice}/maxPrice/${maxPrice}/sortBy/${querySortParams.sortFieldName}/sortDirection/${querySortParams.sortDirection}?offset=${offset}&limit=${limit}`
        );
      }
    }
  }, [
